...
def compute_depth_metrics(gt, pred, mask=None, max_meter = 10, median_align=False):
    ...
    gt[gt<0.1] = 0.1
    pred[pred<0.1] = 0.1
    gt[gt>max_meter] = max_meter
    gt[pred>max_meter] = max_meter
...
class Evaluator(object):
    ...
    def compute_eval_metrics(self, gt_depth, pred_depth, mask, max_meter):
        """
        ...
        abs_, abs_rel, sq_rel, rms, rms_log, log10, a1, a2, a3 = \
            compute_depth_metrics(gt_depth, pred_depth, mask, max_meter, self.median_align)
