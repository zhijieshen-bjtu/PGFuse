...
class Structure3D(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        aug_rrgb = np.concatenate((aug_rgb[:, self.w//8:], aug_rgb[:, :self.w//8]), axis=1)                      
        ...
        inputs["gt_depth"] = 10.0 * gt_depth/3
        ...
        #inputs["gt_depth"] = (inputs["gt_depth"]-inputs["gt_depth"].min())/(inputs["gt_depth"].max() - inputs["gt_depth"].min())*self.max_depth_meters
