...
# dataset
parser.add_argument("--data_path", default="../Matterport3D/", type=str, help="path to the dataset.")
parser.add_argument("--dataset", default="matterport3d", choices=["3d60","structure3d", "panosuncg", "stanford2d3d", "matterport3d"],
...
parser.add_argument("--num_layers", type=int, default=50, choices=[2, 18, 34, 50, 101],
...
parser.add_argument("--log_frequency", type=int, default=1000, help="number of batches between each tensorboard log")
...
# ablation settings
parser.add_argument("--net", type=str, default="PGFuse", choices=["PGFuse", "Equi"], help="model to use")
